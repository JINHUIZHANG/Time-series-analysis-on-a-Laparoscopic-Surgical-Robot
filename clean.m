...
save('data_sort.mat','data_filter_sort','ID')
...
for j = 1:10
    ...
    name = strcat('Plot_Parameters_aligned\',num2str(j),'.fig');
    data_align = yi;
    save('data_align.mat','data_align')
    savefig(name);
end
% find outliers ID
...
save('data_clean_160.mat','data_clean_final','ID_outliers')
...
for j = 1:10
    ...
    name = strcat('Plot_Parameters_aligned\',num2str(j),'_final.fig');
    data_align_final = yi_final;
    save('data_align_final.mat','data_align_final')
    savefig(name);
end
% % recover plot
